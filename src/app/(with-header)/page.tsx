...
import { RecruitingSectionPrefetched } from "@/features/session/components/RecruitingSection/RecruitingSectionPrefetched.server";
 ...
 * 2. RecruitingSectionPrefetched에서 prefetch + HydrationBoundary 처리
 * 3. Suspense로 RecruitingSection만 비동기 스트리밍
 * 4. 나머지 섹션은 독립적으로 렌더링
 *
 * 섹션 구성:
  ...
  return (
    <div className="my-[64px] flex flex-col justify-center gap-[48px] px-[54px]">
      ...
      <Suspense fallback={<RecruitingSectionSkeleton />}>
        <RecruitingSectionPrefetched listParams={listParams} />
      </Suspense>
    </div>
  );
}

export const BACKEND_ERROR_CODES = {
  ...
  SESSION_NOT_HOST: "SESSION403_02",
  SESSION_DELETE_NOT_WAITING: "SESSION400_12",
  SESSION_DELETE_HAS_PARTICIPANTS: "SESSION400_13",
  SESSION_UPDATE_NOT_WAITING: "SESSION400_14",
  SESSION_UPDATE_HAS_PARTICIPANTS: "SESSION400_15",
...
export const ERROR_MESSAGE_MAP = {
  ...
  [BACKEND_ERROR_CODES.SESSION_NOT_HOST]: "세션 주최자만 이용할 수 있어요.",
  [BACKEND_ERROR_CODES.SESSION_DELETE_NOT_WAITING]: "대기 중인 세션만 삭제할 수 있어요.",
  [BACKEND_ERROR_CODES.SESSION_DELETE_HAS_PARTICIPANTS]: "세션에 참여자가 있어 삭제할 수 없어요.",
  [BACKEND_ERROR_CODES.SESSION_UPDATE_NOT_WAITING]: "대기 중인 세션만 수정할 수 있어요.",
  [BACKEND_ERROR_CODES.SESSION_UPDATE_HAS_PARTICIPANTS]: "세션에 참여자가 있어 수정할 수 없어요.",

...
export function WaitingRoomContentSkeleton() {
  return (
    <>
      <div className="relative left-1/2 ml-[-50vw] w-screen" aria-hidden="true">
        <div className="bg-surface-strong h-16 w-full animate-pulse" />
      </div>

      <div className="gap-3xl p-3xl flex flex-col" aria-hidden="true">
        ...
        <div className="gap-lg flex flex-col lg:flex-row">
          <SkeletonBlock className="h-[628px] flex-1 rounded-2xl" />
          <SkeletonBlock className="h-[628px] flex-1 rounded-2xl" />
        </div>
      </div>
    </>

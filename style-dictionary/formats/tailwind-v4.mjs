...
function wrapOutput(sections, { selector, useThemeAtRule }) {
...
export const tailwindV4Format = {
  ...
  format({ dictionary, options = {} }) {
    ...
    const tokens = tokenFilter ? dictionary.allTokens.filter(tokenFilter) : dictionary.allTokens;
 ...
 */
${wrapOutput(sections, { selector, useThemeAtRule })}`;
  },
};
